    ...
    <div>
        <div v-if="tab == 'About me'" class="flex flex-col md:flex-row items-center gap-[48px] mt-[48px] md:mt-[120px] mx-[24px] md:mr-[0px] md:ml-[48px]">
            ...
            <div class="flex flex-col p-6 pt-0 bg-blue-5 rounded-[10px] max-w-[859px] w-[100%] gap-4 h-[480px] md:h-[610px] overflow-y-auto">
                ...
                <p class="text-blue-1 text-b2 xl:text-b1 text-justify body-one">Electrical Engineering graduate passionate about innovation and technology. Experienced in modernizing traditional workflows through Python-driven digital solutions, including building responsive websites for businesses. Skilled in designing functional prototypes—from IoT systems to energy-efficient devices—addressing real-world challenges. With industry expertise in UI/UX design and frontend development, I specialize in tools like Figma and frameworks such as Vue, Nuxt, and TailwindCSS to deliver seamless digital experiences. I’m also deeply interested in AI model training and machine learning, leveraging my engineering insight and Python skills to build efficient, user-centered products. Committed to continuous learning, I aim to contribute to impactful, tech-driven solutions.</p>
