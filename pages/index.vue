    ...
    <div>
        <div v-if="tab == 'About me'" class="flex flex-col md:flex-row items-center gap-[48px] mt-[48px] md:mt-[120px] mx-[24px] md:mr-[0px] md:ml-[48px]">
            ...
            <div class="flex flex-col p-6 pt-0 bg-blue-5 rounded-[10px] max-w-[859px] w-[100%] gap-4 h-[480px] md:h-[610px] overflow-y-auto">
                ...
                <p class="text-blue-1 text-b2 xl:text-b1 text-justify body-one">Electrical Engineering graduate passionate about innovation and technology. Experienced in modernizing traditional workflows through custom Python automation, observability integrations, and building responsive websites for businesses. Skilled in designing functional prototypes—from IoT systems to energy-efficient devices—addressing real-world challenges. I am deeply focused on AI model training and advanced machine learning, blending engineering insight with design thinking to build efficient, user-centered products. With industry experience in Automation, AI training, UI/UX design and frontend development, I specialize in tools like TensorFlow, LangChain, Figma and frameworks such as Vue, Nuxt, and TailwindCSS to deliver seamless digital experiences. Committed to continuous learning, I aim to consistently contribute to impactful, tech-driven solutions.</p>
